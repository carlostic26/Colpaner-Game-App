...
class matesoup extends StatefulWidget {
  const matesoup({super.key});

  @override
  State<matesoup> createState() => _matesoupState();
}

String currentWord = '';
List<String> words = [];

class _matesoupState extends State<matesoup> {
  String _message = "";
  int _timeLeft = 6;
