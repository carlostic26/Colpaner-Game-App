...
class natusoup extends StatefulWidget {
  const natusoup({super.key});

  @override
  State<natusoup> createState() => _natusoupState();
}
...
class _natusoupState extends State<natusoup> {
  String _message = "";
  int _timeLeft = 6;
